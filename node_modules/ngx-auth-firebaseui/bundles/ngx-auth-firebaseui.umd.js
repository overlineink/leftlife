(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('@angular/common/http'), require('@angular/material'), require('@angular/fire/auth'), require('@angular/fire/firestore'), require('@firebase/app'), require('@firebase/auth'), require('@angular/platform-browser'), require('@angular/fire'), require('@angular/flex-layout'), require('@angular-material-extensions/password-strength'), require('@angular/router'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/common', '@angular/core', '@angular/forms', '@angular/common/http', '@angular/material', '@angular/fire/auth', '@angular/fire/firestore', '@firebase/app', '@firebase/auth', '@angular/platform-browser', '@angular/fire', '@angular/flex-layout', '@angular-material-extensions/password-strength', '@angular/router', 'rxjs/operators'], factory) :
    (global = global || self, factory(global.ngxAuthFirebaseui = {}, global.ng.common, global.ng.core, global.ng.forms, global.ng['common,http'], global.ng.material, global.ng.fire.auth, global.ng.fire.firestore, global.app, null, global.ng.platformBrowser, global.ng.fire, global.ng.flexLayout, global.passwordStrength, global.i2, global.operators));
}(this, function (exports, common, i0, forms, http, material, auth, firestore, app, auth$1, platformBrowser, fire, flexLayout, passwordStrength, i2, operators) { 'use strict';
    ...
    var LoggedInGuard$$1 = /** @class */ (function () {
        function LoggedInGuard$$1(config, router, auth$$1) {
            this.config = config;
            this.router = router;
            this.auth = auth$$1;
        }
        ...
        function () {
            var _this = this;
            return this.auth.afa.user.pipe(operators.map((/**
             * @param {?} res
             * @return {?}
             */
            function (res) {
        ...
        /** @nocollapse */ LoggedInGuard$$1.ngInjectableDef = i0.defineInjectable({ factory: function LoggedInGuard_Factory() { return new LoggedInGuard$$1(i0.inject(NgxAuthFirebaseUIConfigToken), i0.inject(i2.Router), i0.inject(AuthProcessService$$1)); }, token: LoggedInGuard$$1, providedIn: "root" });
     ...
     */
    /** @type {?} */
    var NgxAuthFirebaseUIConfigToken = new i0.InjectionToken('NgxAuthFirebaseUIConfig');
